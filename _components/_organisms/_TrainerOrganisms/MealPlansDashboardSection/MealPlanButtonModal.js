...
export const MealPlanButtonModal = (props) => {
		...
		>
			<View style={styles.centeredView}>
				<View style={styles.modalView}>
					...
					<ActionsContainer>
						<SmallButton label="Add food item" buttonStyle={{ width: 200, marginTop: 10 }} onPress={() => handleButtonPress(props.handleAddFoodItem)} />
						<SmallButton label="Assign to client" buttonStyle={{ width: 200, marginTop: 10 }} onPress={() => handleButtonPress(props.handleAssignToClient)} />
